...
const EventCard: React.FC<EventCardProps> = ({
    ...
    return (
        ...
        >
            ...
            <div
                className={`mt-8 flex w-1/2 flex-col ${isReversed ? "text-right" : ""}`}
            >
                <h3
...
const Events: React.FC = () => {
    return (
        <section className="bg-box">
            <div className="container mx-auto px-40 py-30">
                <div>
                    <h2 className="text-subtitle mb-4">Our Events</h2>
                    <p className="mb-4 max-w-3xl">
                        We aim to celebrate UC Irvine&apos;s spirit of
                        innovation by organizing ZotHacks, a beginner friendly
                        hackathon, and IrvineHacks, Orange County&apos;s largest
                        hackathon. Furthermore, our organization regularly host
                        technical and professional development workshops that
                        teach students industry-relevant skills.
                    </p>
                    <PrimaryAnchor href="/events">
                        More Information
                    </PrimaryAnchor>
                </div>
                <EventCard
